...
export const SearchControls = () => {
  ...
  const activeAccordion = serchParams.get('active-accordion') ?? '';
  const selectedStrength = Number(serchParams.get('strength') ?? '0');
    ...
    <>
        ...
        <div className="flex flex-col lg:flex-row gap-4 mb-8">
            ...
            <Input 
              ...
              className="pl-12 h-12 text-lg bg-gray-200" 
              onKeyDown={handleKeyDown}
              defaultValue={serchParams.get('name') || ''}
            />
        </div>
            ...
            <Button 
              ...
              onClick={() => {
                if( activeAccordion === 'advance-filters') {
                  return setQueryParams('active-accordion', '')
                }
